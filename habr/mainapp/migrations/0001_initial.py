# Generated by Django 4.0 on 2022-02-10 15:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('D', 'Черновик'), ('A', 'Активная'), ('H', 'Архивная')], default='A', max_length=1, verbose_name='Статус')),
            ],
            options={
                'db_table': 'article',
